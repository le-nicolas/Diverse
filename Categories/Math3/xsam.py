...
# Simulate a larger dataset with a balanced target variable
np.random.seed(42)
num_samples = 200  # Increased sample size for better distribution
...
data = pd.DataFrame({
    ...
    'Outcome': np.random.choice([0, 1], num_samples, p=[0.5, 0.5])  # Ensuring a balanced distribution
})
