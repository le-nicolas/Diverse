...
# Load the 3D model of the cow (ensure this path points to your model file)
scene = trimesh.load(r'C:\Users\User\Desktop\cow.obj')

# Check if the loaded object is a Scene (which contains multiple meshes)
